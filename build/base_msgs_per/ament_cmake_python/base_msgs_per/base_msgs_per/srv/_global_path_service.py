...
class Metaclass_GlobalPathService_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from base_msgs_per.msg import PNCMap
...
class GlobalPathService_Request(metaclass=Metaclass_GlobalPathService_Request):
    ...
    _fields_and_field_types = {
        ...
        'pnc_map': 'base_msgs_per/PNCMap',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int32'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['base_msgs_per', 'msg'], 'PNCMap'),  # noqa: E501
    )
...
class Metaclass_GlobalPathService(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'base_msgs_per.srv.GlobalPathService')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from base_msgs_per.srv import _global_path_service
...
class GlobalPathService(metaclass=Metaclass_GlobalPathService):
    from base_msgs_per.srv._global_path_service import GlobalPathService_Request as Request
    from base_msgs_per.srv._global_path_service import GlobalPathService_Response as Response
