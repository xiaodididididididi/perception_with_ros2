...
bool base_msgs_per__msg__pnc_map__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("base_msgs_per.msg._pnc_map.PNCMap", full_classname_dest, 33) == 0);
  }
  base_msgs_per__msg__PNCMap * ros_message = _ros_message;
  {  // header
...
PyObject * base_msgs_per__msg__pnc_map__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("base_msgs_per.msg._pnc_map");
