...
bool base_msgs_per__msg__local_speeds_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("base_msgs_per.msg._local_speeds_point.LocalSpeedsPoint", full_classname_dest, 54) == 0);
  }
  base_msgs_per__msg__LocalSpeedsPoint * ros_message = _ros_message;
  {  // t
...
PyObject * base_msgs_per__msg__local_speeds_point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("base_msgs_per.msg._local_speeds_point");
