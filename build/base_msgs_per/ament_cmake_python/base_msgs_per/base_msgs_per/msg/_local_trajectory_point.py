...
class LocalTrajectoryPoint(metaclass=Metaclass_LocalTrajectoryPoint):
    ...
    _fields_and_field_types = {
        'path_point': 'base_msgs_per/LocalPathPoint',
        'speed_point': 'base_msgs_per/LocalSpeedsPoint',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['base_msgs_per', 'msg'], 'LocalPathPoint'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['base_msgs_per', 'msg'], 'LocalSpeedsPoint'),  # noqa: E501
    )
