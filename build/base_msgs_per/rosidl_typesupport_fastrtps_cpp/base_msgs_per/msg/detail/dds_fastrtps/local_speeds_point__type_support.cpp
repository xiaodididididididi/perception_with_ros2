...
#include "base_msgs_per/msg/detail/local_speeds_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const base_msgs_per::msg::LocalSpeedsPoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  base_msgs_per::msg::LocalSpeedsPoint & ros_message)
{
  // Member: t
  cdr >> ros_message.t;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = base_msgs_per::msg::LocalSpeedsPoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const base_msgs_per::msg::LocalSpeedsPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<base_msgs_per::msg::LocalSpeedsPoint *>(
    untyped_ros_message);
...
{
  return &base_msgs_per::msg::typesupport_fastrtps_cpp::_LocalSpeedsPoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_msgs_per, msg, LocalSpeedsPoint)() {
  return &base_msgs_per::msg::typesupport_fastrtps_cpp::_LocalSpeedsPoint__handle;
}
