...
#include "base_msgs_per/msg/detail/obs_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const base_msgs_per::msg::ObsInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  base_msgs_per::msg::ObsInfo & ros_message)
{
  // Member: obs_length
  cdr >> ros_message.obs_length;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = base_msgs_per::msg::ObsInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const base_msgs_per::msg::ObsInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<base_msgs_per::msg::ObsInfo *>(
    untyped_ros_message);
...
{
  return &base_msgs_per::msg::typesupport_fastrtps_cpp::_ObsInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_msgs_per, msg, ObsInfo)() {
  return &base_msgs_per::msg::typesupport_fastrtps_cpp::_ObsInfo__handle;
}
