...
#include "base_msgs_per/srv/detail/pnc_map_service__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const base_msgs_per::srv::PNCMapService_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  base_msgs_per::srv::PNCMapService_Request & ros_message)
{
  // Member: map_type
  cdr >> ros_message.map_type;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = base_msgs_per::srv::PNCMapService_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const base_msgs_per::srv::PNCMapService_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<base_msgs_per::srv::PNCMapService_Request *>(
    untyped_ros_message);
...
{
  return &base_msgs_per::srv::typesupport_fastrtps_cpp::_PNCMapService_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_msgs_per, srv, PNCMapService_Request)() {
  return &base_msgs_per::srv::typesupport_fastrtps_cpp::_PNCMapService_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_base_msgs_per
cdr_serialize(
  const base_msgs_per::srv::PNCMapService_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: pnc_map
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  base_msgs_per::srv::PNCMapService_Response & ros_message)
{
  // Member: pnc_map
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = base_msgs_per::srv::PNCMapService_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const base_msgs_per::srv::PNCMapService_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<base_msgs_per::srv::PNCMapService_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &base_msgs_per::srv::typesupport_fastrtps_cpp::_PNCMapService_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_msgs_per, srv, PNCMapService_Response)() {
  return &base_msgs_per::srv::typesupport_fastrtps_cpp::_PNCMapService_Response__handle;
}
...
{
  return &base_msgs_per::srv::typesupport_fastrtps_cpp::_PNCMapService__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_msgs_per, srv, PNCMapService)() {
  return &base_msgs_per::srv::typesupport_fastrtps_cpp::_PNCMapService__handle;
}
