...
#include "base_msgs_per/srv/detail/global_path_service__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const base_msgs_per::msg::PNCMap &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  base_msgs_per::msg::PNCMap &);
...
cdr_serialize(
  const base_msgs_per::srv::GlobalPathService_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  base_msgs_per::srv::GlobalPathService_Request & ros_message)
{
  // Member: global_planner_type
  cdr >> ros_message.global_planner_type;
  ...
  size_t current_alignment)
{
  ...
  // Member: pnc_map
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        base_msgs_per::msg::typesupport_fastrtps_cpp::max_serialized_size_PNCMap(
  ...
  if (is_plain) {
    ...
    using DataType = base_msgs_per::srv::GlobalPathService_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const base_msgs_per::srv::GlobalPathService_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<base_msgs_per::srv::GlobalPathService_Request *>(
    untyped_ros_message);
...
{
  return &base_msgs_per::srv::typesupport_fastrtps_cpp::_GlobalPathService_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_msgs_per, srv, GlobalPathService_Request)() {
  return &base_msgs_per::srv::typesupport_fastrtps_cpp::_GlobalPathService_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_base_msgs_per
cdr_serialize(
  const base_msgs_per::srv::GlobalPathService_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: global_path
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  base_msgs_per::srv::GlobalPathService_Response & ros_message)
{
  // Member: global_path
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = base_msgs_per::srv::GlobalPathService_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const base_msgs_per::srv::GlobalPathService_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<base_msgs_per::srv::GlobalPathService_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &base_msgs_per::srv::typesupport_fastrtps_cpp::_GlobalPathService_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_msgs_per, srv, GlobalPathService_Response)() {
  return &base_msgs_per::srv::typesupport_fastrtps_cpp::_GlobalPathService_Response__handle;
}
...
{
  return &base_msgs_per::srv::typesupport_fastrtps_cpp::_GlobalPathService__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_msgs_per, srv, GlobalPathService)() {
  return &base_msgs_per::srv::typesupport_fastrtps_cpp::_GlobalPathService__handle;
}
