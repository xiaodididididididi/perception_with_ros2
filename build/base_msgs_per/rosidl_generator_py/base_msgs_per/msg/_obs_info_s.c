...
bool base_msgs_per__msg__obs_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("base_msgs_per.msg._obs_info.ObsInfo", full_classname_dest, 35) == 0);
  }
  base_msgs_per__msg__ObsInfo * ros_message = _ros_message;
  {  // obs_length
...
PyObject * base_msgs_per__msg__obs_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("base_msgs_per.msg._obs_info");
