...
class PlotInfo(metaclass=Metaclass_PlotInfo):
    ...
    _fields_and_field_types = {
        ...
        'trajectory_info': 'base_msgs_per/LocalTrajectory',
        'obs_info': 'sequence<base_msgs_per/ObsInfo>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['base_msgs_per', 'msg'], 'LocalTrajectory'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['base_msgs_per', 'msg'], 'ObsInfo')),  # noqa: E501
    )
