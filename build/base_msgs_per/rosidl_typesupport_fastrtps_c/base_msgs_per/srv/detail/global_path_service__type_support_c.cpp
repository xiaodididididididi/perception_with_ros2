...
#include "base_msgs_per/srv/detail/global_path_service__rosidl_typesupport_fastrtps_c.h"
...
#include "base_msgs_per/msg/detail/pnc_map__functions.h"  // pnc_map

// forward declare type support functions
size_t get_serialized_size_base_msgs_per__msg__PNCMap(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_base_msgs_per__msg__PNCMap(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, base_msgs_per, msg, PNCMap)();


using _GlobalPathService_Request__ros_msg_type = base_msgs_per__srv__GlobalPathService_Request;
  ...
  // Field name: pnc_map
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, base_msgs_per, msg, PNCMap
      )()->data);
...
size_t get_serialized_size_base_msgs_per__srv__GlobalPathService_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GlobalPathService_Request__ros_msg_type * ros_message = static_cast<const _GlobalPathService_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_base_msgs_per__msg__PNCMap(
...
static uint32_t _GlobalPathService_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_base_msgs_per__srv__GlobalPathService_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_base_msgs_per
size_t max_serialized_size_base_msgs_per__srv__GlobalPathService_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: pnc_map
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_base_msgs_per__msg__PNCMap(
  ...
  if (is_plain) {
    ...
    using DataType = base_msgs_per__srv__GlobalPathService_Request;
    is_plain =
      (
...
static size_t _GlobalPathService_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_msgs_per__srv__GlobalPathService_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, base_msgs_per, srv, GlobalPathService_Request)() {
...
using _GlobalPathService_Response__ros_msg_type = base_msgs_per__srv__GlobalPathService_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_base_msgs_per
size_t get_serialized_size_base_msgs_per__srv__GlobalPathService_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GlobalPathService_Response__ros_msg_type * ros_message = static_cast<const _GlobalPathService_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_base_msgs_per__srv__GlobalPathService_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_base_msgs_per
size_t max_serialized_size_base_msgs_per__srv__GlobalPathService_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = base_msgs_per__srv__GlobalPathService_Response;
    is_plain =
      (
...
static size_t _GlobalPathService_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_msgs_per__srv__GlobalPathService_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, base_msgs_per, srv, GlobalPathService_Response)() {
...
// already included above
// #include "base_msgs_per/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "base_msgs_per/srv/global_path_service.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, base_msgs_per, srv, GlobalPathService)() {
