...
#include "base_msgs_per/srv/detail/pnc_map_service__rosidl_typesupport_fastrtps_c.h"
...
using _PNCMapService_Request__ros_msg_type = base_msgs_per__srv__PNCMapService_Request;
...
size_t get_serialized_size_base_msgs_per__srv__PNCMapService_Request(
  const void * untyped_ros_message,
...
static uint32_t _PNCMapService_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_base_msgs_per__srv__PNCMapService_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_base_msgs_per
size_t max_serialized_size_base_msgs_per__srv__PNCMapService_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = base_msgs_per__srv__PNCMapService_Request;
    is_plain =
      (
...
static size_t _PNCMapService_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_msgs_per__srv__PNCMapService_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, base_msgs_per, srv, PNCMapService_Request)() {
...
using _PNCMapService_Response__ros_msg_type = base_msgs_per__srv__PNCMapService_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_base_msgs_per
size_t get_serialized_size_base_msgs_per__srv__PNCMapService_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PNCMapService_Response__ros_msg_type * ros_message = static_cast<const _PNCMapService_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_base_msgs_per__srv__PNCMapService_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_base_msgs_per
size_t max_serialized_size_base_msgs_per__srv__PNCMapService_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = base_msgs_per__srv__PNCMapService_Response;
    is_plain =
      (
...
static size_t _PNCMapService_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_msgs_per__srv__PNCMapService_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, base_msgs_per, srv, PNCMapService_Response)() {
...
// already included above
// #include "base_msgs_per/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "base_msgs_per/srv/pnc_map_service.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, base_msgs_per, srv, PNCMapService)() {
