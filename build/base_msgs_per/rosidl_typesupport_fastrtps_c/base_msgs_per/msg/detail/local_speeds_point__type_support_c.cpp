...
#include "base_msgs_per/msg/detail/local_speeds_point__rosidl_typesupport_fastrtps_c.h"
...
using _LocalSpeedsPoint__ros_msg_type = base_msgs_per__msg__LocalSpeedsPoint;
...
static uint32_t _LocalSpeedsPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_base_msgs_per__msg__LocalSpeedsPoint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = base_msgs_per__msg__LocalSpeedsPoint;
    is_plain =
      (
...
static size_t _LocalSpeedsPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_msgs_per__msg__LocalSpeedsPoint(
