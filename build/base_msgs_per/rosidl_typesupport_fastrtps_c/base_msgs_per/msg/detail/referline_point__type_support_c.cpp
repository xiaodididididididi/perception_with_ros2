...
#include "base_msgs_per/msg/detail/referline_point__rosidl_typesupport_fastrtps_c.h"
...
using _ReferlinePoint__ros_msg_type = base_msgs_per__msg__ReferlinePoint;
...
static uint32_t _ReferlinePoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_base_msgs_per__msg__ReferlinePoint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = base_msgs_per__msg__ReferlinePoint;
    is_plain =
      (
...
static size_t _ReferlinePoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_msgs_per__msg__ReferlinePoint(
...
static message_type_support_callbacks_t __callbacks_ReferlinePoint = {
  "base_msgs_per::msg",
  "ReferlinePoint",
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, base_msgs_per, msg, ReferlinePoint)() {
  return &_ReferlinePoint__type_support;
}
