...
#include "base_msgs_per/msg/detail/pnc_map__rosidl_typesupport_fastrtps_c.h"
...
using _PNCMap__ros_msg_type = base_msgs_per__msg__PNCMap;
...
static uint32_t _PNCMap__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_base_msgs_per__msg__PNCMap(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = base_msgs_per__msg__PNCMap;
    is_plain =
      (
...
static size_t _PNCMap__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_msgs_per__msg__PNCMap(
