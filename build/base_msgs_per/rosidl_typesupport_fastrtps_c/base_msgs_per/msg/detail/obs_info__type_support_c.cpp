...
#include "base_msgs_per/msg/detail/obs_info__rosidl_typesupport_fastrtps_c.h"
...
using _ObsInfo__ros_msg_type = base_msgs_per__msg__ObsInfo;
...
static uint32_t _ObsInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_base_msgs_per__msg__ObsInfo(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = base_msgs_per__msg__ObsInfo;
    is_plain =
      (
...
static size_t _ObsInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_msgs_per__msg__ObsInfo(
