...
#ifndef BASE_MSGS_PER__MSG__DETAIL__PNC_MAP__TRAITS_HPP_
#define BASE_MSGS_PER__MSG__DETAIL__PNC_MAP__TRAITS_HPP_
...
inline void to_yaml(
  const base_msgs_per::msg::PNCMap & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const base_msgs_per::msg::PNCMap & msg)
{
  return base_msgs_per::msg::to_yaml(msg);
}

template<>
inline const char * data_type<base_msgs_per::msg::PNCMap>()
{
  return "base_msgs_per::msg::PNCMap";
}

template<>
inline const char * name<base_msgs_per::msg::PNCMap>()
{
  return "base_msgs_per/msg/PNCMap";
}

template<>
struct has_fixed_size<base_msgs_per::msg::PNCMap>
  : std::integral_constant<bool, has_fixed_size<std_msgs::msg::Header>::value && has_fixed_size<visualization_msgs::msg::Marker>::value> {};

template<>
struct has_bounded_size<base_msgs_per::msg::PNCMap>
...
template<>
struct is_message<base_msgs_per::msg::PNCMap>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // BASE_MSGS_PER__MSG__DETAIL__PNC_MAP__TRAITS_HPP_
