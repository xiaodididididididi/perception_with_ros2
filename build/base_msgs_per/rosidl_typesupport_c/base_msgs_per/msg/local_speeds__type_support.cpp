...
static const _LocalSpeeds_type_support_symbol_names_t _LocalSpeeds_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, base_msgs_per, msg, LocalSpeeds)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, base_msgs_per, msg, LocalSpeeds)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, base_msgs_per, msg, LocalSpeeds)() {
  return &::base_msgs_per::msg::rosidl_typesupport_c::LocalSpeeds_message_type_support_handle;
}
