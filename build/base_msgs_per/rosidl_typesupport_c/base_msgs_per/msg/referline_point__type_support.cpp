...
static const _ReferlinePoint_type_support_symbol_names_t _ReferlinePoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, base_msgs_per, msg, ReferlinePoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, base_msgs_per, msg, ReferlinePoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, base_msgs_per, msg, ReferlinePoint)() {
  return &::base_msgs_per::msg::rosidl_typesupport_c::ReferlinePoint_message_type_support_handle;
}
