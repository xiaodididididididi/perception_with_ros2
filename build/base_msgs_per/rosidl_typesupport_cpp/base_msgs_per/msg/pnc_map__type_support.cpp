...
static const _PNCMap_type_support_symbol_names_t _PNCMap_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_msgs_per, msg, PNCMap)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, base_msgs_per, msg, PNCMap)),
  }
};
...
{
  return &::base_msgs_per::msg::rosidl_typesupport_cpp::PNCMap_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, base_msgs_per, msg, PNCMap)() {
  return get_message_type_support_handle<base_msgs_per::msg::PNCMap>();
}
