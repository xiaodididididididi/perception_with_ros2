...
def generate_launch_description():
    perception_path = get_package_share_directory("perception")
    car_path = os.path.join(perception_path, "urdf/main_car", "car.xacro")
    obs_car_path = os.path.join(perception_path, "urdf/obs_car", "obs_car.xacro")
    rviz_conf_path = os.path.join(perception_path, "rviz", "perception.rviz")
    ...
    perception_process = Node(
        package="perception",
        executable="perception_process",
