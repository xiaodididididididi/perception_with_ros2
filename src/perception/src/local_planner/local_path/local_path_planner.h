...
#include "base_msgs_per/msg/local_path_point.hpp"
#include "base_msgs_per/msg/referline.hpp"
...
namespace Perception
{
    ...
    using base_msgs_per::msg::LocalPathPoint;
    using base_msgs_per::msg::Referline;
