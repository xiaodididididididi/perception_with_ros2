#ifndef PERCEPTION_PROCESS_H_
#define PERCEPTION_PROCESS_H_

#include "rclcpp/rclcpp.hpp"
#include "base_msgs_per/msg/pnc_map.hpp"
#include "base_msgs_per/srv/global_path_service.hpp"
#include "base_msgs_per/srv/pnc_map_service.hpp"
...
namespace Perception
{
  ...
  using base_msgs_per::msg::PNCMap;
  using base_msgs_per::srv::GlobalPathService;
  using base_msgs_per::srv::PNCMapService;
  ...
  class PerceptionProcess : public rclcpp::Node
  {
  public:
    PerceptionProcess();
    bool process();
