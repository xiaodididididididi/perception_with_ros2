...
class Metaclass_PNCMapService(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'base_msgs_per.srv.PNCMapService')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from base_msgs_per.srv import _pnc_map_service
...
class PNCMapService(metaclass=Metaclass_PNCMapService):
    from base_msgs_per.srv._pnc_map_service import PNCMapService_Request as Request
    from base_msgs_per.srv._pnc_map_service import PNCMapService_Response as Response
