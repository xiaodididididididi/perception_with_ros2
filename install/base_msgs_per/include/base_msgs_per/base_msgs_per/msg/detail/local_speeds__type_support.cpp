...
#include "base_msgs_per/msg/detail/local_speeds__struct.hpp"
...
{
  new (message_memory) base_msgs_per::msg::LocalSpeeds(_init);
}

void LocalSpeeds_fini_function(void * message_memory)
{
  auto typed_message = static_cast<base_msgs_per::msg::LocalSpeeds *>(message_memory);
  typed_message->~LocalSpeeds();
}

size_t size_function__LocalSpeeds__local_speeds(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<base_msgs_per::msg::LocalSpeedsPoint> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<base_msgs_per::msg::LocalSpeedsPoint> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<base_msgs_per::msg::LocalSpeedsPoint> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const base_msgs_per::msg::LocalSpeedsPoint *>(
    get_const_function__LocalSpeeds__local_speeds(untyped_member, index));
  auto & value = *reinterpret_cast<base_msgs_per::msg::LocalSpeedsPoint *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<base_msgs_per::msg::LocalSpeedsPoint *>(
    get_function__LocalSpeeds__local_speeds(untyped_member, index));
  const auto & value = *reinterpret_cast<const base_msgs_per::msg::LocalSpeedsPoint *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LocalSpeeds_message_member_array[2] = {
  {
    ...
    offsetof(base_msgs_per::msg::LocalSpeeds, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(base_msgs_per::msg::LocalSpeeds, local_speeds),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers LocalSpeeds_message_members = {
  ...
  2,  // number of fields
  sizeof(base_msgs_per::msg::LocalSpeeds),
...
get_message_type_support_handle<base_msgs_per::msg::LocalSpeeds>()
{
  return &::base_msgs_per::msg::rosidl_typesupport_introspection_cpp::LocalSpeeds_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, base_msgs_per, msg, LocalSpeeds)() {
  return &::base_msgs_per::msg::rosidl_typesupport_introspection_cpp::LocalSpeeds_message_type_support_handle;
}
