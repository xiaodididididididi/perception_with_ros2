...
#ifndef BASE_MSGS_PER__MSG__DETAIL__PNC_MAP__STRUCT_HPP_
#define BASE_MSGS_PER__MSG__DETAIL__PNC_MAP__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__base_msgs_per__msg__PNCMap __attribute__((deprecated))
#else
# define DEPRECATED__base_msgs_per__msg__PNCMap __declspec(deprecated)
#endif
...
struct PNCMap_
{
  ...
  using ConstRawPtr =
    const base_msgs_per::msg::PNCMap_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<base_msgs_per::msg::PNCMap_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<base_msgs_per::msg::PNCMap_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      base_msgs_per::msg::PNCMap_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<base_msgs_per::msg::PNCMap_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<base_msgs_per::msg::PNCMap_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<base_msgs_per::msg::PNCMap_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<base_msgs_per::msg::PNCMap_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__base_msgs_per__msg__PNCMap
    std::shared_ptr<base_msgs_per::msg::PNCMap_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__base_msgs_per__msg__PNCMap
    std::shared_ptr<base_msgs_per::msg::PNCMap_<ContainerAllocator> const>
...
using PNCMap =
  base_msgs_per::msg::PNCMap_<std::allocator<void>>;
...
#endif  // BASE_MSGS_PER__MSG__DETAIL__PNC_MAP__STRUCT_HPP_
