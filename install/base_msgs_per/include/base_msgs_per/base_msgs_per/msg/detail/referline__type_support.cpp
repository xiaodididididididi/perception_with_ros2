...
{
  new (message_memory) base_msgs_per::msg::Referline(_init);
}

void Referline_fini_function(void * message_memory)
{
  auto typed_message = static_cast<base_msgs_per::msg::Referline *>(message_memory);
  typed_message->~Referline();
}

size_t size_function__Referline__refer_line(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<base_msgs_per::msg::ReferlinePoint> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<base_msgs_per::msg::ReferlinePoint> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<base_msgs_per::msg::ReferlinePoint> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const base_msgs_per::msg::ReferlinePoint *>(
    get_const_function__Referline__refer_line(untyped_member, index));
  auto & value = *reinterpret_cast<base_msgs_per::msg::ReferlinePoint *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<base_msgs_per::msg::ReferlinePoint *>(
    get_function__Referline__refer_line(untyped_member, index));
  const auto & value = *reinterpret_cast<const base_msgs_per::msg::ReferlinePoint *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Referline_message_member_array[2] = {
  {
    ...
    offsetof(base_msgs_per::msg::Referline, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<base_msgs_per::msg::ReferlinePoint>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(base_msgs_per::msg::Referline, refer_line),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Referline_message_members = {
  ...
  2,  // number of fields
  sizeof(base_msgs_per::msg::Referline),
...
{
  return &::base_msgs_per::msg::rosidl_typesupport_introspection_cpp::Referline_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, base_msgs_per, msg, Referline)() {
  return &::base_msgs_per::msg::rosidl_typesupport_introspection_cpp::Referline_message_type_support_handle;
}
